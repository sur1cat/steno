...
**Подключаешь репозиторий — steno учит словарь твоей команды. Коммиты сами
закрывают задачи, о которых на созвоне не говорили.**
...
одной встречи. Один бинарник на Go. Записи и расшифровки остаются у тебя —
наружу уходит только текст, в Claude, чтобы собрать follow-up.

```
$ steno start
telegram: слушаю ссылки на созвоны
панель: слушаю 127.0.0.1:8422

иду на «Планёрка» (https://meet.google.com/abc-defg-hij, повод: календарь)
bot: в звонке
bot: пишу звук в data/recordings/2026-09-09-1100-a1b2/audio.ogg
bot: запись окончена: остался один, 47m12s, участников 5
расшифровываю (large-v3-q5_0)
реплик: 412, из них с именем: 397
делаю follow-up (claude-sonnet-5)
задач: 6, решений: 3, открытых вопросов: 2
расход: вход 2, выход 3.7k, кеш 12k/10k — $0.12
telegram: отправлено
```
...
готовить заранее ничего не нужно. Начинает с вопроса, как ты будешь этим
