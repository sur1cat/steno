...
//
// Правила взяты из internal/panel/web/app/src/lib/fmt.ts: один и тот же
// созвон в браузере и в строке меню должен называться одинаково — человек
// смотрит то туда, то сюда и сверяет глазами. Отсюда же и согласование числа
// со словом: «2 созвона» вместо «2 созвон» — это разница между интерфейсом и
// машинным переводом.
