...
Проекты описываются в конфиге — с псевдонимами, потому что вслух их называют
не так, как они записаны:

```json
"projects": [
  {"name": "Платежи", "aliases": ["биллинг", "payments"], "about": "приём денег"},
  {"name": "Инфраструктура", "aliases": ["инфра", "деплой"], "about": "выкаты и очереди"}
]
```
