...
9. Расшифровка машинная: в ней есть оговорки, обрывы и неверно распознанные
   ...
   Что с этим делать:
   - Помеченное имя не назначай исполнителем, пока не поймёшь по разговору, о
     ком речь. Понял — пиши имя из списка участников или из «людей» проекта.
     Не понял — оставь как прозвучало и заведи открытый вопрос, что имя
     расслышано плохо.
   - Помеченное название сервиса или проекта скорее всего не новое слово, а
     искажённое известное — сверься со списками «сервисы и сокращения».
